...
### 🎯 需求驱动的重要改进
- **副本文件生成**: 默认生成副本文件而不修改原文件 (如 `README-copy.md`)
- **README特殊处理**: 翻译README.md时自动生成 `README.zh-CN.md`
- **目标语言配置**: 新增默认目标语言配置选项
- **CLI工具支持**: 提供命令行工具进行批量处理
- **测试样例**: 添加完整的测试样例文件

### 🔧 配置选项扩展
- **默认目标语言**: 支持8种语言 (中文、英语、日语、韩语、法语、德语、西班牙语、俄语)
- **文件处理模式**: 可选择生成副本文件或直接修改原文件
- **CLI命令**: `emt -i input.md -l zh-CN -e openai`
